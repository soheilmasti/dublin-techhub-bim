  ...
  villas: {
    ...
    translations: {
      en: {
        ...
        description: 'Topography-harmonized architecture, Violet Villa, Tehrandasht, Australia, Diamond Town & Pergolas',
        shortcuts: [
          { label: 'Front Cover', page: 0 },
          { label: 'Manifesto & Index', page: 1 },
          { label: 'Violet Villa (Concept)', page: 3 },
          { label: 'Violet Villa (CAD Plans)', page: 5 },
          { label: 'Violet Villa (Steel Frame)', page: 7 },
          { label: 'Violet Villa (Site Execution)', page: 9 },
          { label: 'Tehran Dasht Villa', page: 11 },
          { label: 'Tehran Dasht (Rebar Execution)', page: 13 },
          { label: 'Modern Villa Series', page: 15 },
          { label: 'Modern Villa (Plans & Details)', page: 17 },
          { label: 'Australia Curved Villa', page: 19 },
          { label: 'Australia Villa (Pool Pavilion)', page: 21 },
          { label: 'Diamond Villa Town', page: 23 },
          { label: 'Landscape Pergolas & Outdoor', page: 25 },
      ...
      fa: {
        ...
        description: 'معماری همساز با شیب، ویلاهای مجلل وایولت، تهراندشت، استرالیا، شهرک الماس و پرگولا',
        shortcuts: [
          { label: 'روی جلد', page: 0 },
          { label: 'مانیفست و فهرست', page: 1 },
          { label: 'ویلای وایولت (کانسپت)', page: 3 },
          { label: 'ویلای وایولت (پلان‌های CAD)', page: 5 },
          { label: 'ویلای وایولت (سازه فلزی)', page: 7 },
          { label: 'ویلای وایولت (نظارت کارگاهی)', page: 9 },
          { label: 'ویلای مدرن تهراندشت', page: 11 },
          { label: 'تهراندشت (آرماتوربندی و استخر)', page: 13 },
          { label: 'مجموعه ویلاهای مدرن', page: 15 },
          { label: 'ویلاهای مدرن (پلان و جزییات)', page: 17 },
          { label: 'ویلای منحنی استرالیا', page: 19 },
          { label: 'ویلای استرالیا (پاویون استخر)', page: 21 },
          { label: 'شهرک ویلایی دایموند', page: 23 },
          { label: 'محوطه‌سازی و پرگولا', page: 25 },
      ...
      es: {
        ...
        shortcuts: [
          ...
          { label: 'Villa Violet (Concepto)', page: 3 },
          { label: 'Villa Violet (Planos CAD)', page: 5 },
          { label: 'Villa Violet (Estructura)', page: 7 },
          { label: 'Villa Violet (Dirección Obra)', page: 9 },
          { label: 'Villa Tehrandasht', page: 11 },
          { label: 'Tehrandasht (Armaduras y Obra)', page: 13 },
          { label: 'Serie Villas Modernas', page: 15 },
          { label: 'Villas Modernas (Planos y Madera)', page: 17 },
          { label: 'Villa Curva Australia', page: 19 },
          { label: 'Villa Australia (Pabellón Piscina)', page: 21 },
          { label: 'Urbanización Diamond', page: 23 },
          { label: 'Paisajismo y Pérgolas', page: 25 },
      ...
      ca: {
        ...
        shortcuts: [
          ...
          { label: 'Vil·la Violet (Concepte)', page: 3 },
          { label: 'Vil·la Violet (Plànols CAD)', page: 5 },
          { label: 'Vil·la Violet (Estructura)', page: 7 },
          { label: 'Vil·la Violet (Direcció Obra)', page: 9 },
          { label: 'Vil·la Tehrandasht', page: 11 },
          { label: 'Tehrandasht (Armadures i Obra)', page: 13 },
          { label: 'Sèrie Vil·les Modernes', page: 15 },
          { label: 'Vil·les Modernes (Plànols i Fusta)', page: 17 },
          { label: 'Vil·la Curba Austràlia', page: 19 },
          { label: 'Vil·la Austràlia (Pavelló Piscina)', page: 21 },
          { label: 'Urbanització Diamond', page: 23 },
          { label: 'Paisatgisme i Pèrgoles', page: 25 },
...
export const BimcoPortfolioFlipbookModal: React.FC<BimcoPortfolioFlipbookModalProps> = ({
  ...
  const pageImages = useMemo(() => {
    return Array.from({ length: currentConfig.totalPages }, (_, i) => 
      `${currentConfig.pagesFolder}/page_${String(i + 1).padStart(2, '0')}.jpg?v=${CACHE_KEY}`
    );
  }, [currentConfig, CACHE_KEY]);
